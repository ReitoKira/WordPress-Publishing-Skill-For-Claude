...
[![Version](https://img.shields.io/badge/version-1.0.0-green)](https://github.com/yourusername/wordpress-publisher-skill/releases)
...
```bash
# Add the marketplace
/plugin marketplace add yourusername/wordpress-publisher-skill
...
git clone https://github.com/yourusername/wordpress-publisher-skill.git ~/.claude/skills/wordpress-publisher
```
...
git clone https://github.com/yourusername/wordpress-publisher-skill.git ~/.codex/skills/wordpress-publisher
```
...
git clone https://github.com/yourusername/wordpress-publisher-skill.git
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/wordpress-publisher-skill/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/wordpress-publisher-skill/discussions)
